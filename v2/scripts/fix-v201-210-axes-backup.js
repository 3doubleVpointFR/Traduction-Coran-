...
const axesData = [
  ...
  {
    verse_id: 209, word_key: "sre", position: 7, concept: "Hâte/Précipitation",
    axes: {
  ...
  // ===================== V203 (vid=210) =====================
  {
    verse_id: 210, word_key: "athm", position: 11, concept: "Châtiment/Conséquence",
    axes: athm_chatiment_axes
  },
  {
    verse_id: 210, word_key: "athm", position: 16, concept: "Châtiment/Conséquence",
    axes: athm_chatiment_axes
  },
  {
    verse_id: 210, word_key: "athm", position: 11, concept: "Culpabilité/Remords",
    axes: athm_culpabilite_axes
  },
  {
    verse_id: 210, word_key: "athm", position: 16, concept: "Culpabilité/Remords",
    axes: athm_culpabilite_axes
  },
  {
    verse_id: 210, word_key: "edd", position: 5, concept: "Préparation",
    axes: {
  ...
  {
    verse_id: 210, word_key: "hshr", position: 27, concept: "Sens isolé/Expulser",
    axes: {
  ...
  {
    verse_id: 210, word_key: "ywm", position: 4, concept: "Événement/Moment marquant",
    axes: {
  ...
  // ===================== V205 (vid=212) =====================
  {
    verse_id: 212, word_key: "nsl", position: 12, concept: "Chute/Détachement",
    axes: {
  ...
  {
    verse_id: 212, word_key: "wly", position: 2, concept: "Autorité",
    axes: {
  ...
  // ===================== V206 (vid=213) =====================
  {
    verse_id: 213, word_key: "axdh", position: 6, concept: "Châtiment",
    axes: {
  ...
  {
    verse_id: 213, word_key: "mhd", position: 15, concept: "Préparation/Aplanissement",
    axes: {
  ...
  // ===================== V207 (vid=214) =====================
  {
    verse_id: 214, word_key: "ebd", position: 13, concept: "Adoration/Dévotion",
    axes: {
  ...
  {
    verse_id: 214, word_key: "rwf", position: 11, concept: "Douceur/Délicatesse",
    axes: {
  ...
  // ===================== V208 (vid=215) =====================
  {
    verse_id: 215, word_key: "amn", position: 2, concept: "Sécurité/Confiance",
    axes: {
  ...
  {
    verse_id: 215, word_key: "edw", position: 13, concept: "Transgression/Excès",
    axes: {
  ...
  {
    verse_id: 215, word_key: "slm", position: 5, concept: "Intégrité/Santé",
    axes: {
  ...
  {
    verse_id: 215, word_key: "stn", position: 10, concept: "Éloignement/Distance",
    axes: {
  ...
  // ===================== V209 (vid=216) =====================
  {
    verse_id: 216, word_key: "ezz", position: 10, concept: "Rareté/Valeur",
    axes: {
  ...
  {
    verse_id: 216, word_key: "hkm", position: 11, concept: "Jugement/Décision",
    axes: {
  ...
  // ===================== V210 (vid=217) =====================
  {
    verse_id: 217, word_key: "amr", position: 14, concept: "Commandement/Autorité",
    axes: {
