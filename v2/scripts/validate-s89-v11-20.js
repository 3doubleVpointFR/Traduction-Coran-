// Validation Pipeline Sourate 89 (v11-20)
...
async function validate() {
  console.log('=== VALIDATION SOURATE 89 (v11-20) ===\n');
  ...
  const { data: va } = await sb.from('verse_analyses').select('verse_id, segments, translation_explanation, translation_arab, full_translation, verses!inner(verse_num, surah_id)')
    .eq('verses.surah_id', 89).gte('verses.verse_num', 11).lte('verses.verse_num', 20).order('verses(verse_num)');

  if (!va || va.length === 0) { err('Aucune verse_analyses pour sourate 89 v11-20'); return; }
  ...
  const rootIds = {
    tgy: 2598, bld: 793, kṯr: 413, fsd: 318,
    Sbb: 2638, rbb: 253, swT: 2639, edb: 314,
    rsd: 2024, ans: 866, blw: 918, krm: 1470,
    nem: 264, qwl: 307, qdr: 373, rzq: 284,
    hwn: 1303, ytm: 664, hdd2: 2590, taem: 1726,
    skn: 462, akl: 947, wrṯ: 1480, lmm: 473,
    hbb: 930, mwl: 1148, jmm: 2640
  };
  ...
  // Print translations
  console.log('\n=== TRADUCTIONS COMPLÈTES SOURATE 89 (v11-20) ===');
  for (const v of va) {
